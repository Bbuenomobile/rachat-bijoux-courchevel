...
export const metadata = {
  title: "Rachat Lingots & Pièces d'Or à Courchevel 1850 | Cours Officiel de l'Or | " + site.name,
  description: "Achat et estimation d'or d'investissement à Courchevel 1850 : lingots certifiés LBMA (10g à 1kg) et pièces d'or (Napoléons, Souverains, Krugerrands). Virement instantané.",
  alternates: {
    canonical: `${site.url}/rachat-lingots-pieces-or-courchevel`,
  },
};
...
export default function Page() {
  return (
    <ServicePage
      slug="rachat-lingots-pieces-or-courchevel"
      hero={{
        eyebrow: "Or d'Investissement · Courchevel 1850",
        title: "Rachat de Lingots et Pièces d'Or à Courchevel : Cours Spot en Direct",
        titleHighlight: "Transparence Totale & Cours de Bourse",
        intro: "Rachat immédiat d'or fin 24 carats (999,9/1000) et pièces d'or de bourse au fixing officiel de Londres (LBMA) à Courchevel 1850.",
        image: "https://images.unsplash.com/photo-1610375461246-83df859d849d?auto=format&fit=crop&w=1600&q=80",
        imageAlt: "Rachat de lingots d'or certifiés LBMA et pièces à Courchevel 1850",
      }}
      category="Or d'Investissement"
      defaultItemType="Lingots ou Pièces d'Or"
      defaultSubject="Estimation Or d'Investissement à Courchevel"
      introBlock={{
        eyebrow: "Or d'Investissement · Courchevel 1850",
        title: "Comptoir Professionnel d'Or d'Investissement à Courchevel",
        paragraphs: ["Les lingots scellés issus de fondeurs reconnus Good Delivery LBMA (Metalor, C.Hafner, Umicore, Argor-Heraeus, Valcambi) et les pièces d'or historiques constituent des actifs de réserve de premier plan.", "Dans notre cabinet de Courchevel, nous achetons lingotins de 10g à 500g, lingots de 1 kilo ainsi que les monnaies d'or françaises et internationales (Napoléon 20 Francs, Croix Suisse 20 CHF, Souverain George V, Krugerrand, American Eagle).", "La valorisation s'effectue strictement au fixing du marché en direct, avec respect scrupuleux du cadre fiscal français applicable aux métaux précieux (TMP ou TPV)."],
      }}
      criteria={criteria}
      process={process}
      gallery={gallery}
