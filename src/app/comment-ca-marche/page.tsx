...
export const metadata: Metadata = {
  title: "Comment ça Marche — Rachat Joaillerie & Diamants | Courchevel 1850",
  description: "Découvrez notre processus transparent de rachat de bijoux, diamants et montres à Courchevel 1850 : estimation sous vos yeux, offre ferme au cours mondial et virement instantané.",
  ...
  const steps = [
    {
      ...
      desc: "Contactez notre cabinet par téléphone, WhatsApp ou via notre formulaire sécurisé. Vous nous transmettez le descriptif de vos pièces (certificats GIA, factures, photos ou boîtes d'origine si disponibles) afin de convenir d'un rendez-vous confidentiel à Courchevel 1850 ou à votre chalet.",
    },
    {
      num: "02",
      title: "Expertise Gemmologique Sous Vos Yeux",
      desc: "Dans nos salons privés de la Rue du Rocher ou dans l'intimité de votre résidence alpine, nos gemmologues diplômés analysent chaque pièce avec un matériel scientifique de pointe : réfractomètre, polariscope, microscope gemmologique et spectromètre.",
    },
    {
      num: "03",
    ...
    },
    {
      ...
      desc: "Après signature de l'acte de vente et présentation d'une pièce d'identité conforme à la législation française, le paiement est immédiatement déclenché par virement bancaire instantané SEPA ou international sur votre compte.",
    },
  ];
    ...
    <Section className="py-16 md:py-24">
      <div className="container-x max-w-4xl space-y-16">
        <div className="text-center space-y-4">
          ...
          <h1 className="h1 text-ink-900">Comment Vendre Vos Bijoux à Courchevel</h1>
