...
export const metadata: Metadata = {
  title: "Politique de Confidentialité | Rachat Bijoux Courchevel",
  description: "Politique de protection des données personnelles et respect de la confidentialité des clients de Maison Obagem à Courchevel 1850.",
