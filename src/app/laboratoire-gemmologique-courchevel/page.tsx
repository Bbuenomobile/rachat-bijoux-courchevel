...
export const metadata: Metadata = {
  title: "Laboratoire Gemmologique à Courchevel 1850 | Rachat Bijoux Courchevel",
  description: "Instruments scientifiques de précision pour l'analyse et la certification de diamants, pierres précieuses et haute joaillerie à Courchevel 1850.",
  alternates: { canonical: `${site.url}/laboratoire-gemmologique-courchevel` },
};
    ...
    <>
      <Section className="py-16 md:py-24 bg-[#08162b] text-white">
        <div className="container-x max-w-4xl text-center space-y-6">
          ...
          <h1 className="h1 text-white">Laboratoire Gemmologique & Expertise Scientifique à Courchevel</h1>
          <p className="lead text-ink-200 max-w-2xl mx-auto">
            Nous disposons d'équipements analytiques de pointe à Courchevel 1850 pour authentifier et certifier chaque gemme avec une rigueur irréprochable.
          </p>
        </div>
      </Section>
        ...
        <div className="container-x max-w-5xl">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-6 space-y-6 text-ink-700 leading-relaxed">
              ...
              <p>
                Dans notre cabinet de Courchevel 1850, chaque analyse est conduite selon des méthodes strictement non destructives préservant la perfection de vos pièces de haute joaillerie.
              </p>
              <p>
            ...
            <div className="lg:col-span-6">
              <div className="relative h-[440px] rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  alt="Laboratoire gemmologique scientifique à Courchevel 1850"
                  fill
      ...
      <Section className="bg-[#08162b] text-white">
        <div className="container-x max-w-3xl text-center space-y-6">
          <h2 className="font-display text-3xl font-semibold">Prendre Rendez-vous au Laboratoire à Courchevel</h2>
          <p className="text-ink-200 text-sm md:text-base leading-relaxed">
            Consultez nos gemmologues diplômés dans nos salons privés de Courchevel 1850 ou demandez un déplacement sécurisé avec équipement d'expertise dans votre chalet ou hôtel.
          </p>
