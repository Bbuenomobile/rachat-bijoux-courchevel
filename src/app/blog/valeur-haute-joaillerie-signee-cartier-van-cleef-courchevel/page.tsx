...
export const metadata: Metadata = {
  title: "Guide Gemmologique Courchevel | " + site.name,
  description: "Article technique et informatif rédigé par les gemmologues diplômés de Rachat Bijoux Courchevel.",
  alternates: { canonical: `${site.url}/blog/valeur-haute-joaillerie-signee-cartier-van-cleef-courchevel` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'valeur-haute-joaillerie-signee-cartier-van-cleef-courchevel');
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/valeur-haute-joaillerie-signee-cartier-van-cleef-courchevel`,
  };
        ...
        <div className="container-x max-w-4xl">
          ...
          <header className="space-y-4 text-center mb-12">
            ...
            <div className="flex items-center justify-center gap-4 text-xs text-ink-500 pt-2">
              <span>Maison Obagem Courchevel</span>
              <span>•</span>
      ...
      <Section className="bg-sand-50">
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              headline="Conseil Gemmologique Personnalisé à Courchevel"
              ...
              source="blog:valeur-haute-joaillerie-signee-cartier-van-cleef-courchevel"
            />
          </div>
        </div>
      </Section>
