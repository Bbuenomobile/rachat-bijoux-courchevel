...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${site.url}/blog/guide-vendre-diamants-courchevel` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'guide-vendre-diamants-courchevel');
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/guide-vendre-diamants-courchevel`,
  };
        ...
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              ...
              source="blog:guide-vendre-diamants-courchevel"
            />
          </div>
        </div>
      </Section>
