...
export const metadata: Metadata = {
  title: "Blog & Analyses Gemmologiques Rapaport | Rachat Bijoux Courchevel",
  description: "Articles techniques et analyses du marché de l'art : cotation officielle Rapaport, haute joaillerie signée et montres de collection à Courchevel 1850.",
  alternates: { canonical: `${site.url}/blog` },
};

const blogImages: Record<string, string> = {
  'guide-vendre-diamants-courchevel': 'https://images.unsplash.com/photo-1605100804763-247f67b3557e?auto=format&fit=crop&w=800&q=80',
  'comprendre-les-4c-du-diamant-courchevel': 'https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?auto=format&fit=crop&w=800&q=80',
  'certificats-gia-vs-hrd-ssef-courchevel': 'https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?auto=format&fit=crop&w=800&q=80',
  'vendre-montre-luxe-rolex-patek-richard-mille-courchevel': 'https://images.unsplash.com/photo-1522335789203-aabd1fc54bc9?auto=format&fit=crop&w=800&q=80',
  'valeur-haute-joaillerie-signee-cartier-van-cleef-courchevel': 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?auto=format&fit=crop&w=800&q=80',
    ...
    <Section className="py-16 md:py-24">
      <div className="container-x">
        <div className="text-center space-y-4 mb-16">
          ...
          <h1 className="h1">Guides et Articles Spécialisés sur les Bijoux et Diamants à Courchevel</h1>
