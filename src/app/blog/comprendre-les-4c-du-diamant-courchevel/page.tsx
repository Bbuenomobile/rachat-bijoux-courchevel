...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${site.url}/blog/comprendre-les-4c-du-diamant-courchevel` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'comprendre-les-4c-du-diamant-courchevel');
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/comprendre-les-4c-du-diamant-courchevel`,
  };
        ...
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              ...
              source="blog:comprendre-les-4c-du-diamant-courchevel"
            />
          </div>
        </div>
      </Section>
