...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${site.url}/blog/certificats-gia-vs-hrd-ssef-courchevel` },
};

export default function BlogPostPage() {
  const post = blogPosts.find((p) => p.slug === 'certificats-gia-vs-hrd-ssef-courchevel');
  ...
  const articleJsonLd = {
    ...
    mainEntityOfPage: `${site.url}/blog/certificats-gia-vs-hrd-ssef-courchevel`,
  };
        ...
        <div className="container-x max-w-4xl">
          <div className="bg-white rounded-2xl border border-ink-900/10 p-8 md:p-12 shadow-sm">
            <ContactForm
              ...
              source="blog:certificats-gia-vs-hrd-ssef-courchevel"
            />
          </div>
        </div>
      </Section>
