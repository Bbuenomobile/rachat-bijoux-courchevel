...
export const metadata: Metadata = {
  title: "Contact & Salons Privés Courchevel 1850 | Rachat Bijoux Courchevel",
  description: "Prenez rendez-vous en salons privés à la Rue du Rocher à Courchevel 1850 ou convenez d'un déplacement sécurisé à votre chalet privé ou palace dans les 3 Vallées.",
    ...
    <Section className="py-16 md:py-24">
      <div className="container-x max-w-5xl">
        <div className="text-center space-y-4 mb-16">
          ...
          <h1 className="h1 text-ink-900">Contacter Nos Gemmologues à Courchevel 1850</h1>
          <p className="lead text-ink-600 max-w-2xl mx-auto">
            Nous vous recevons en toute discrétion dans nos salons privés à la Rue du Rocher ou organisons une visite à domicile dans votre chalet ou hôtel de prestige dans les 3 Vallées.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-5 space-y-8">
            <div className="bg-[#081a30] text-white p-8 rounded-2xl shadow-xl space-y-6">
              <h2 className="font-display text-2xl font-semibold">Salons Privés Courchevel</h2>
              <div className="space-y-4 text-sm text-ink-200">
                <div>
                  ...
                  <p>{site.address.postalCode} {site.address.city} 1850 ({site.region})</p>
                  <p>France</p>
                </div>
