...
export const metadata: Metadata = {
  title: "Foire Aux Questions (FAQ) | Rachat Bijoux Courchevel 1850",
  description: "Réponses à toutes vos questions sur l'expertise, l'estimation et le rachat de haute joaillerie, diamants et montres de collection à Courchevel 1850.",
  ...
  const faqs = [
    {
      ...
      a: "La valorisation d'un diamant certifié (GIA, HRD, IGI ou SSEF) repose sur la règle des 4C (Carat, Color, Clarity, Cut) et sur la grille officielle internationale du Rapaport Diamond Report, actualisée chaque semaine. Nous y appliquons les décotes ou surcotes réelles du marché international de la haute joaillerie.",
    },
    {
    ...
    {
      q: "Pouvez-vous vous déplacer à notre chalet ou palace à Courchevel ?",
      a: "Oui. Pour des pièces de haute joaillerie, collections horlogères ou diamants d'investissement importants, nos gemmologues experts se déplacent dans la plus stricte discrétion dans votre chalet privé, palace (Les Airelles, Cheval Blanc, K2...) ou résidence alpine dans toutes les stations des 3 Vallées et Megève.",
    },
    {
      q: "Quel est le délai de paiement lors d'une transaction ?",
      a: "Le paiement est instantané. Dès acceptation de notre offre d'achat ferme et vérification des pièces d'identité requises par la législation française, nous effectuons immédiatement un virement bancaire instantané SEPA ou international sur votre compte.",
    },
    {
      q: "Quelles sont les marques de haute joaillerie les plus recherchées ?",
      a: "Nous rachetons avec de fortes primes à la signature les créations des grandes maisons de la Place Vendôme et internationales : Cartier, Van Cleef & Arpels, Boucheron, Graff, Bulgari, Chaumet, Chopard, Harry Winston et Buccellati.",
    },
    {
      ...
      <div className="container-x max-w-4xl space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="lead text-ink-600 max-w-2xl mx-auto">
            Retrouvez les réponses aux interrogations de nos clients privés et collectionneurs à Courchevel.
          </p>
        </div>
