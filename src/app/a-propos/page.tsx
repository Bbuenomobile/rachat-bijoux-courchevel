...
export const metadata: Metadata = {
  title: "À Propos — Maison Obagem Courchevel | Tradition Joaillière & Expertise Gemmologique",
  description: "Depuis plus de quatre décennies, Maison Obagem conseille une clientèle privée exigeante, collectionneurs et études notariales pour l'évaluation et le rachat de haute joaillerie à Courchevel 1850.",
      ...
      <Section className="py-16 md:py-24">
        <div className="container-x max-w-4xl space-y-12">
          <div className="text-center space-y-4">
            <span className="label text-[#d4af37]">Maison Obagem Courchevel</span>
            ...
            <p className="lead text-ink-600 max-w-2xl mx-auto">
              Une tradition d'intégrité, de rigueur scientifique et de discrétion absolue à Courchevel 1850, dans les 3 Vallées et les Alpes.
            </p>
          </div>
          ...
          <div className="relative h-[400px] w-full rounded-2xl overflow-hidden shadow-xl">
            <Image
              ...
              alt="Maison Obagem Courchevel 1850 Salons Privés Rue du Rocher"
              fill
          ...
          <div className="space-y-6 text-ink-700 leading-relaxed text-base md:text-lg bg-white p-8 md:p-12 rounded-2xl border border-ink-900/10 shadow-sm">
            ...
            <p>
              À <strong>Courchevel 1850 (Rue du Rocher)</strong> ainsi que dans les grands chalets et palaces de la station, nos gemmologues diplômés appliquent les critères d'évaluation les plus rigoureux reconnus par le Gemological Institute of America (GIA) et le laboratoire suisse SSEF.
            </p>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-3">
                <span className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#081a30] text-white text-xs font-bold mt-0.5">✓</span>
                <div>
                  <strong>Confidentialité & Discrétion Alpine :</strong> Vos entretiens ont lieu en salons privés sur rendez-vous ou à votre chalet/suite d'hôtel, dans le strict respect du secret des affaires.
                </div>
              </li>
              <li className="flex items-start gap-3">
                <span className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#081a30] text-white text-xs font-bold mt-0.5">✓</span>
                <div>
                  <strong>Paiement Immédiat :</strong> Dès accord sur notre proposition d'achat, le montant est transféré sans délai par virement bancaire instantané sécurisé.
                </div>
              </li>
            </ul>
          </div>
