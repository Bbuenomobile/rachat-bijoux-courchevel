...
export const metadata: Metadata = {
  title: "Mentions Légales | Rachat Bijoux Courchevel",
  description: "Mentions légales, informations juridiques et conditions d'utilisation du site rachat-bijoux-courchevel.site.",
