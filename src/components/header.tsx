        ...
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-[10px] uppercase tracking-[0.18em] text-[#d4af37]">
              Courchevel 1850 · Palaces & Chalets
            </span>
          </div>
        </Link>

        <nav className="hidden xl:flex items-center gap-6 text-xs uppercase tracking-wider font-medium text-ink-200">
          <Link href="/rachat-diamant-courchevel" className="hover:text-white transition-colors">Diamants GIA</Link>
          <Link href="/rachat-bijoux-anciens-courchevel" className="hover:text-white transition-colors">Bijoux & Or</Link>
          <Link href="/rachat-haute-joaillerie-signee-courchevel" className="hover:text-white transition-colors">Haute Joaillerie</Link>
          <Link href="/rachat-montres-luxe-courchevel" className="hover:text-white transition-colors">Montres de Prestige</Link>
